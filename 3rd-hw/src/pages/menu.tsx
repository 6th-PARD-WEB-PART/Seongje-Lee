        ...
        <div className="mx-auto max-w-[1200px] h-16 flex items-center justify-between px-4">
          <div className="flex items-center">
            ...
            <nav className="ml-8 h-6 flex items-center whitespace-nowrap">
              {["중고거래", "부동산", "중고차", "알바", "동네업체", "동네생활", "모임"].map(
                (label) => (
                  <span
                    key={label}
        ...
        <div className="w-full">
          <div className="mx-auto max-w-[1200px] px-4 py-3">
            ...
            <div className="mt-2 flex flex-wrap gap-2">
              {["#에어팟", "#아이폰", "#삼성", "#냉장고", "#자전거", "#노트북", "#의자", "#책상"].map(
                (tag) => (
                  <span
                    key={tag}
        ...
        <aside className="col-span-12 md:col-span-3">
          <div className="bg-white rounded-lg p-4 border border-gray-200">
            ...
            <div className="mt-5">
              ...
              <div className="mt-1 text-sm text-gray-600">인천광역시 연수구</div>

              <ul className="mt-2 max-h-48 overflow-auto space-y-2 text-sm text-gray-700">
                {["송도동", "송도1동", "송도2동", "연수동", "동춘동", "청학동"].map(
                  (dong, i) => (
            ...
            {Array.from({ length: 7 }).map((_, idx) => (
              ...
              >
                ...
                <div className="px-3 py-2 flex justify-end items-center gap-2">
                  {/* 하트표시 */}
                  <img
                    src="/icons/Icon-187.svg"
                    alt=""
                    aria-hidden="true"
                    className="w-5 h-4"
                  />
                  <button className="px-3 py-1.5 bg-orange-500 text-white text-xs font-medium rounded-lg">
                    자세히
                  </button>
                </div>
              </article>
